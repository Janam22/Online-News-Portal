          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="#" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">NORMAL USER PANEL</span>
              </a>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{ route('normaluser.profile') }}" style="color:black;">
                  <i class="fas fa-cogs fa-sm fa-fw mr-2 text-dark-600"></i>
                  Profile
                </a>

                <a class="dropdown-item" href="{{ route('normaluser.change-password') }}" style="color:black;">
